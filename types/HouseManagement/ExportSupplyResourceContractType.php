...
O - в разрезе объектов жилищного фонда. 
     ...
     */
    public function __construct(\gisgkh\types\HouseManagement\ExportSupplyResourceContractType\IsContract $IsContract = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\IsNotContract $IsNotContract = null, string $ComptetionDate = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\Period $Period = null, \gisgkh\types\NsiBase\nsiRef $ContractBase = null, string $Offer = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\ApartmentBuildingOwner $ApartmentBuildingOwner = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\LivingHouseOwner $LivingHouseOwner = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\Organization $Organization = null, string $IsPlannedVolume = null, array $ContractSubject = null, string $CountingResource = null, string $SpecifyingQualityIndicators = null, array $ObjectAddress = null, array $Quality = null, array $OtherQualityIndicator = null, array $TemperatureChart = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\BillingDate $BillingDate = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\PaymentDate $PaymentDate = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\ProvidingInformationDate $ProvidingInformationDate = null)
    {
