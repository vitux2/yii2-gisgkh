...
namespace gisgkh\types\HouseManagement\MeteringDeviceFullInformationType;
...
class LinkedWithMetering
{
     ...
     */
    public function __construct(string $InstallationPlace = null, array $LinkedMeteringDeviceVersionGUID = null)
    {
