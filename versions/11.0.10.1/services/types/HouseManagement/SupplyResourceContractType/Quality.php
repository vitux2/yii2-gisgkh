...
class Quality
{
     ...
     * 
     * @var \gisgkh\types\HouseManagement\SupplyResourceContractType\Quality\IndicatorValue
     */
     ...
     * @param \gisgkh\types\HouseManagement\SupplyResourceContractType\Quality\IndicatorValue [$IndicatorValue] Значение показателя качества
     */
    public function __construct(string $AddressObjectKey = null, string $PairKey = null, \gisgkh\types\NsiBase\nsiRef $QualityIndicator = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\Quality\IndicatorValue $IndicatorValue = null)
    {
