...
namespace gisgkh\types\HouseManagement\ExportSupplyResourceContractType\ObjectAddress;
...
class Pair
{
     ...
     * 
     * @var \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\ObjectAddress\Pair\HeatingSystemType
     */
     ...
     * @param \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\ObjectAddress\Pair\HeatingSystemType [$HeatingSystemType] Тип системы теплоснабжения (заполняется для коммунальных ресурсов "Тепловая энергия" и "Горячая вода")
     */
    public function __construct(string $PairKey = null, string $StartSupplyDate = null, string $EndSupplyDate = null, \gisgkh\types\HouseManagement\ExportSupplyResourceContractType\ObjectAddress\Pair\HeatingSystemType $HeatingSystemType = null)
    {
