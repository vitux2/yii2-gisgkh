...
class SupplyResourceContractType extends GisgkhType
{
    ...
    /**
     * @var RegOrgType $Organization Управляющая организация
     */
    ...
    /**
     * @var SupplyResourceContractType_BillingDate $BillingDate Срок выставления платежных документов, не позднее: (число месяца, следующего за расчетным).
    ...
    /**
     * @var SupplyResourceContractType_BillingDate $PaymentDate Срок внесения платы, не позднее: (число месяца, следующего за расчетным).
     * Является обязательным, если вторая сторона договора отличается от "Управляющая организация"
     * и договор не является публичным и/или присутствует заключенный на бумажном носителе или в электронной форме.
     */
    ...
    /**
     * @var SupplyResourceContractType_BillingDate $ProvidingInformationDate Срок предоставления информации о поступивших платежах (число месяца, следующего за расчетным).
