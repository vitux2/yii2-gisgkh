...
O - в разрезе объектов жилищного фонда. 
     ...
     */
    public function __construct(\gisgkh\types\HouseManagement\SupplyResourceContractType\IsContract $IsContract = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\IsNotContract $IsNotContract = null, string $ComptetionDate = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\Period $Period = null, \gisgkh\types\NsiBase\nsiRef $ContractBase = null, string $Offer = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\ApartmentBuildingOwner $ApartmentBuildingOwner = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\LivingHouseOwner $LivingHouseOwner = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\Organization $Organization = null, string $IsPlannedVolume = null, array $ContractSubject = [], string $CountingResource = null, string $SpecifyingQualityIndicators = null, array $ObjectAddress = [], array $Quality = [], array $OtherQualityIndicator = [], array $TemperatureChart = [], \gisgkh\types\HouseManagement\SupplyResourceContractType\BillingDate $BillingDate = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\PaymentDate $PaymentDate = null, \gisgkh\types\HouseManagement\SupplyResourceContractType\ProvidingInformationDate $ProvidingInformationDate = null)
    {
